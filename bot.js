...
client.on("message", message => {
 ...
 if (message.content === "$help") {
  ...
  const embed = new Discord.RichEmbed()
      .setColor("RANDOM")
      .addField("『Bot 1 | Arab Community』 『 ❸ⒷⓀⓇⒺⓃⓄ.ღ 』", true)
      
      .addField("『  !    ＭＯ３ＡＺ ⊗#1599 』", true)
...
💎$topinv  『لمعرفة اكثر الاشخاص الي جابوا ناس للسيرفر.
...
القسم الثالث مصمم البوت | @!    ＭＯ３ＡＺ ⊗#1599
...
if (message.content === '$support') {
      message.author.send(' https/discord.gg/6Gg666U '//discord.gg/T4Q7vXP| لـ أي استفسار').catch(e => console.log(e.stack));
...
if (message.content === '!invite') {
      message.author.send(' رابط البوت |  https: https:discordapp.com/oauth2/authorize?client_id=%20337702789285150720%20&scope=bot&permissions=269671551 //discordapp.com/api/oauth2/authorize?client_id=469548363399036946&permissions=2146958583&scope=bot ').catch(e => console.log(e.stack));
